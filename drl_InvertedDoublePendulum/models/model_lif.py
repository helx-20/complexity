...
class QNetwork(nn.Module):
    ...
    def forward(self, state, action, wins=15):
        ...
        #input = torch.stack([input]*wins,dim=1).to(device)
        #print(input)
        ...
        #print("layer1:",torch.mean(h1_sumspike/wins))
        #print("layer2:",torch.mean(h2_sumspike/wins))
        #print(input_seq[:,-1,:])
...
class GaussianPolicy(nn.Module):
    def __init__(self, num_inputs, num_actions, hidden_dim, action_space=None):
        ...
        self.lif_layer1 = LIF_neuron(num_inputs, hidden_dim)
        self.lif_layer2 = LIF_neuron(hidden_dim, hidden_dim)
